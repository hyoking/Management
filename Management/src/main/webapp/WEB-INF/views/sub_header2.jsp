...
<body>
  ...
  <div class="sub_header">
	<div>
		<ul>
			<li><a href="<c:url value="/employee"/>" class="employee_item01">재고관리</a></li>
			<li><a href="<c:url value="/employeeRegister"/>" class="employee_item02">영업관리</a></li>
			<li><a href="#" class="employee_item03">생산관리</a></li>
		</ul>
	</div>	
</div>
